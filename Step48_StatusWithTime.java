...
public class Step48_StatusWithTime {
    public static void main(String[] args) {
        ...
        Runnable refreshTable = ()-> {
            ...
            for (int i = 0; i < products.size(); i++) {
                ...
                data[i][3] = products.get(i).getStatus() + products.get(i).getlatestTime();
            }
        ...
        statusButton.addActionListener(ex -> {
            ...
            if (row >= 0) {
                ...
                for (Map<String, String> entry : history) {
                    String s = entry.get("status");
                    String t = entry.get("time");
                    message.append("- ").append(t).append(": ").append(s).append("\n");
                }
...
class Product {
    ...
    private java.util.List<Map<String, String>> statusHistory = new ArrayList<>();
    ...
    public String getlatestTime() {
        ...
        Map<String, String> latest = statusHistory.get(statusHistory.size() -1);
    ...
    public java.util.List<Map<String, String>> getAllStatus() {
